...
(function () {
  ...
  var script = document.createElement('script');
  script.src = './public-copy-fixes.js?v=1.18';
...
// Profil recensé : Samuella Kouassi (TikTok, Instagram).
(function () {
...
(function () {
  ...
  var script = document.createElement('script');
  script.src = './live-radar-v3.js?v=1.14';
...
(function () {
  ...
  var script = document.createElement('script');
  script.src = './profile-cahie-kunta.js?v=1.1';
  script.dataset.pass50ProfileCahieKunta = '1.1';
  document.head.appendChild(script);
})();
...
(function () {
  ...
  var script = document.createElement('script');
  script.src = './profile-sara.js?v=1.0';
  script.dataset.pass50ProfileSara = '1.0';
  document.head.appendChild(script);
})();
