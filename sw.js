...
const CACHE='pass50-v81-service-worker-disabled';
...
const ASSETS=[
  ...
  './content-intelligence.js?v=1.2','./mon-fil.js?v=2.2',
  './duel-audio-feed-v1.js?v=1.1','./mobile-modal-video-progress-v1.js?v=1.0',
  './context-share-v1.js?v=1.0','./context-share-v2.js?v=2.0',
  './classability-sync-v1.js?v=1.4','./mobile-bottom-nav-v1.js?v=1.1',
  './mobile-bottom-nav-v1.js?v=1.2','./share-center-v1.js?v=1.0',
  ...
  './profile-ismael-aka.js?v=1.0','./profile-general-camille-makosso.js?v=1.0',
  ...
  './live-radar-v3.js?v=1.7','./live-trust-gate-v1.js?v=1.2',
  './live-experience-v4-1.js?v=1.4','./live-dismiss-ui-v1.js?v=1.0',
  ...
  './v9-tools.css?v=22.4','./v9-tools.js?v=15.6',
  './pass50_nouveaux_candidats_90_v19.json?v=22.8','./data-engine-ui.js?v=18.7',
  ...
  './assets/hero-media-3.jpg','./assets/hero-media-4.jpg','./data-engine-ui.css?v=27.1'
];
void ASSETS;
