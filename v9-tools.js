...
renderContent=function(){const grid=$('#contentGrid');if(!grid)return;grid.querySelectorAll('.content-card:not(.p50ci-card),[data-content="c1"],[data-content="c2"],[data-content="c3"],[data-content="c4"],[data-content="c5"]').forEach(el=>{if(!el.classList.contains('p50ci-card'))el.remove()});if(grid.querySelector('.p50ci-card'))return;grid.classList.add('p50-content-grid-loading');grid.innerHTML='<div class="p50ci-empty p50-content-wait" role="status">Chargement des tendances…</div>'}
