...
(function(){
  'use strict';
  const CENSUS_URL='./pass50_nouveaux_candidats_90_v19.json?v=22.22';
  const CENSUS_VERSION='99-v39';
  let importing=false;
