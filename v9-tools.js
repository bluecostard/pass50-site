...
(function(){
  'use strict';
  const CENSUS_URL='./pass50_nouveaux_candidats_90_v19.json?v=22.18';
  const CENSUS_VERSION='99-v35';
  let importing=false;
