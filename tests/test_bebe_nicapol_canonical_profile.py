...
class BebeNicapolCanonicalProfileTests(unittest.TestCase):
    ...
    def test_browser_loads_census_revision_96_v27(self):
        self.assertIn("pass50_nouveaux_candidats_90_v19.json?v=22.14", self.v9)
        self.assertIn("CENSUS_VERSION='99-v31'", self.v9)
        ...
        self.assertEqual(index_version.group(1), "15.17")
        self.assertEqual(worker_version.group(1), "15.17")
        self.assertIn("pass50_nouveaux_candidats_90_v19.json?v=22.14", self.sw)
