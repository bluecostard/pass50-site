...
class CanonicalLionelYasmineV24Tests(unittest.TestCase):
    ...
    def test_browser_fetches_the_new_census_revision(self):
        self.assertIn('pass50_nouveaux_candidats_90_v19.json?v=22.9', V9)
        self.assertIn("const CENSUS_VERSION='95-v26'", V9)
        self.assertIn('pass50_nouveaux_candidats_90_v19.json?v=22.9', SW)
