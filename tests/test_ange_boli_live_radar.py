...
class AngeBoliLiveRadarTests(unittest.TestCase):
    ...
    def test_unique_census_handle(self):
        ...
        self.assertNotIn("'angeboli7'=>'census-ange-morel'", SOURCE)
    ...
    def test_github_webcast_includes_handle(self):
        ...
        self.assertNotEqual(handles.get(HANDLE), 'census-ange-morel')
