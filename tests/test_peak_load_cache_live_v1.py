...
class PeakLoadCacheLiveV1Tests(unittest.TestCase):
    def test_status_uses_fast_cache_path(self):
        ...
        self.assertIn("p50_de_sync_registry_if_stale", endpoint)
        self.assertLess(endpoint.find("p50_live_status_cache_respond()"), endpoint.find("p50_de_sync_registry_if_stale"))
