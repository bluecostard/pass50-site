...
class ContentIntelligenceV1Tests(unittest.TestCase):
    ...
    def test_public_interface_refreshes_without_session_staleness(self):
        ...
        self.assertIn("content-intelligence.js?v=1.10", CONFIG)
        self.assertIn("content-intelligence.js?v=1.10", SW)
        self.assertIn("déjà en base", CLIENT)
        self.assertIn("officialNewsHoursApplied", CLIENT)
        self.assertIn("Aucune actu en 72 h", CLIENT)
        self.assertIn("moins de 72 heures", CLIENT)
