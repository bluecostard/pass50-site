...
class ContentIntelligenceV1Tests(unittest.TestCase):
    ...
    def test_public_content_is_strictly_fresh(self):
        ...
        self.assertIn("officialNewsHoursApplied", FEED)
    ...
    def test_facebook_posts_have_readable_pass50_preview_and_optional_insights(self):
        ...
        self.assertNotIn("Aperçu lisible dans Pass50", CLIENT)
    ...
    def test_public_interface_refreshes_without_session_staleness(self):
        ...
        self.assertIn("collect_work", CLIENT)
        ...
        self.assertIn("officialNewsHoursApplied", FEED)
        self.assertNotIn("Aucune actu en 72 h", CLIENT)
        self.assertNotIn("moins de 72 heures", CLIENT)
        self.assertNotIn("Chargement des publications officielles", CLIENT)
        self.assertNotIn("contenus officiels + validations", CLIENT)
