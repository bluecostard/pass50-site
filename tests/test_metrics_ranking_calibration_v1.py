...
class MetricsRankingCalibrationV1Tests(unittest.TestCase):
    ...
    def test_versions_and_admin_scoped_styles_are_coherent(self):
        ...
        index_v9 = re.search(r"v9-tools\.js\?v=([0-9.]+)", INDEX)
        worker_v9 = re.search(r"v9-tools\.js\?v=([0-9.]+)", SW)
        self.assertIsNotNone(index_v9)
        self.assertIsNotNone(worker_v9)
        self.assertEqual(index_v9.group(1), worker_v9.group(1))
