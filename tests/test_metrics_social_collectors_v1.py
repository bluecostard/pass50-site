...
class SocialCollectorsV1Tests(unittest.TestCase):
    ...
    def test_multinetwork_probe_is_hmac_protected_and_read_only(self):
        ...
        self.assertIn("function p50_multinet_preview",READINESS_CRON)
        self.assertIn("p50_mo_dispatch($pdo,$cadence",READINESS_CRON)
        self.assertIn("p50_multinet_preview($pdo,'p0'",READINESS_CRON)
        self.assertIn("p50_multinet_preview($pdo,'p1'",READINESS_CRON)
