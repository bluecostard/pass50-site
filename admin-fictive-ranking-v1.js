(function(){
  ...
  function install(){
    ...
    card.innerHTML='<strong style="color:#ffd08a">CLASSEMENT FICTIF MR‑V1.0</strong><p style="margin:7px 0 11px;color:#cbd3c8;font-size:13px">Consultez le candidat expérimental et la couverture YouTube, X, TikTok, Instagram, Facebook et Snapchat. Le classement public reste inchangé.</p><a class="btn small" href="./classement-fictif.html" target="_blank" rel="noopener">Ouvrir le classement fictif</a>';
    body.prepend(card);
  }
