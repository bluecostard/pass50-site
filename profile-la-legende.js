...
const PROFILE_ID='census-la-legende';
const TIKTOK_URL='https://www.tiktok.com/@lalegende777';
let attempts=0;
...
function baseProfile(){
  return {
    ...
    photoStatus:'missing',
    photoSource:'',
    photoNote:'Photo à valider depuis le compte TikTok @lalegende777.',
    photoPosition:'50% 50%',
    ...
    linkChecks:{
      TikTok:verifiedLink('Compte TikTok @lalegende777 confirmé — La légende, recensé le 23 août 2026.')
    },
    verifiedPass50:false,
    censusStatus:'Recensé confirmé',
    verificationPriority:'P0',
    knownAlias:'La légende / @lalegende777',
    source:{publisher:'Signalement PASS50 — profil TikTok La légende',date:'2026-08-23',url:TIKTOK_URL},
    notes:'Humoriste. Compte TikTok officiel unique @lalegende777. Nom civil et date de naissance non confirmés.'
  };
}
