(function(){
  ...
  if(!document.querySelector('script[data-pass50-meta-oauth-diagnostics]')){const script=document.createElement('script');script.src='./meta-oauth-diagnostics-v1.js?v=1.0';script.dataset.pass50MetaOauthDiagnostics='1.0';document.head.appendChild(script);}
