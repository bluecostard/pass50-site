(function(){
  ...
  if(!document.querySelector('script[data-pass50-context-share]')){const script=document.createElement('script');script.src='./context-share-v1.js?v=1.0';script.async=false;script.dataset.pass50ContextShare='1.0';document.head.appendChild(script);}
