(function(){
  ...
  if(!document.querySelector('script[data-pass50-live-trust-gate]')){const script=document.createElement('script');script.src='./live-trust-gate-v1.js?v=1.0';script.dataset.pass50LiveTrustGate='1.0';document.head.appendChild(script);}
  if(!document.querySelector('script[data-pass50-live-experience-v41]')){const script=document.createElement('script');script.src='./live-experience-v4-1.js?v=1.2';script.dataset.pass50LiveExperienceV41='1.2';document.head.appendChild(script);}
