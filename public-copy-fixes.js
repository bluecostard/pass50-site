(function(){
  ...
  if(!document.querySelector('script[data-pass50-live-trust-gate]')){const script=document.createElement('script');script.src='./live-trust-gate-v1.js?v=1.1';script.dataset.pass50LiveTrustGate='1.1';document.head.appendChild(script);}
