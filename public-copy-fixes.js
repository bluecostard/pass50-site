(function(){
  ...
  if(!document.querySelector('script[data-pass50-classability-sync]')){const script=document.createElement('script');script.src='./classability-sync-v1.js?v=1.0';script.async=false;script.dataset.pass50ClassabilitySync='1.0';document.head.appendChild(script);}
