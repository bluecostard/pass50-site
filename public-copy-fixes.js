(function(){
  ...
  if(!document.querySelector('script[data-pass50-live-experience-v41]')){const script=document.createElement('script');script.src='./live-experience-v4-1.js?v=1.1';script.dataset.pass50LiveExperienceV41='1.1';document.head.appendChild(script);}
