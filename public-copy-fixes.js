(function(){
  ...
  if(!document.querySelector('script[data-pass50-meta-oauth-ui]')){const script=document.createElement('script');script.src='./meta-oauth-ui-v1.js?v=1.3';script.dataset.pass50MetaOauthUi='1.3';document.head.appendChild(script);}
})();
