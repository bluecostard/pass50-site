(function(){
  ...
  if(!document.querySelector('script[data-pass50-live-experience-v41]')){const script=document.createElement('script');script.src='./live-experience-v4-1.js?v=1.3';script.dataset.pass50LiveExperienceV41='1.3';document.head.appendChild(script);}
  ...
  if(!document.querySelector('script[data-pass50-mobile-bottom-nav]')){const script=document.createElement('script');script.src='./mobile-bottom-nav-v1.js?v=1.1';script.async=false;script.dataset.pass50MobileBottomNav='1.1';document.head.appendChild(script);}
})();
