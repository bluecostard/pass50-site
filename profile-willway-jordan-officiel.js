...
const PROFILE_ID='census-willway-jordan-officiel';
const TIKTOK_URL='https://www.tiktok.com/@jack.carter39';
let attempts=0;

function verifiedLink(message){
  return {status:'manual_verified',checkedAt:'2026-08-24T14:58:00.000Z',message};
}
...
function baseProfile(){
  return {
    ...
    photoStatus:'missing',
    photoSource:'',
    photoNote:'Photo à valider depuis le compte TikTok @jack.carter39.',
    photoPosition:'50% 50%',
    ...
    linkChecks:{
      TikTok:verifiedLink('Compte TikTok @jack.carter39 confirmé — Willway Jordan officiel, recensé le 24 août 2026.')
    },
    verifiedPass50:false,
    censusStatus:'Recensé confirmé',
    verificationPriority:'P0',
    knownAlias:'Willway Jordan officiel / @jack.carter39',
    source:{publisher:'Signalement PASS50 — profil TikTok Willway Jordan officiel',date:'2026-08-24',url:TIKTOK_URL},
    notes:'Créateur TikTok. Compte officiel @jack.carter39. Distinct de Jordan Evraa (@realjordanevraa). Identité civile et date de naissance non confirmées.'
  };
}
