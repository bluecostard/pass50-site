...
(() => {
  ...
  const FALLBACK_VIEW = {
    ...
    sections: [
      ...
      { num: '2', title: 'N°1 du classement le plus souvent', name: 'Apoutchou National', detail: '5 fois en tête (24H)', metric: '5×', metricLabel: 'en tête', profileId: 'apoutchou', photoUrl: '/api/weekly-digest-photo.php?id=apoutchou&size=480' },
