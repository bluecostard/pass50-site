...
json_response(['ok'=>true,'engine'=>'PASS50 Data Engine','version'=>22,'threshold'=>$threshold,'profiles'=>$profiles,'eligibleProfiles'=>$eligible,'verifiedFacts'=>$verifiedFacts,'verifiedLinks'=>$verifiedLinks,'lastRun'=>$lastRun]);
