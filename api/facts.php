...
$sourceType=((string)($user['role']??'')==='owner')?'manual_owner':'manual_admin';
$weight=$sourceType==='manual_owner'?100:98;
...
json_response(['ok'=>true,'normalizedValue'=>$value,'automaticMatch'=>$autoMatched,'message'=>'Source administrateur enregistrée et publiée immédiatement, sauf conflit manuel explicite.']+p50_fact_payload($profileId));
