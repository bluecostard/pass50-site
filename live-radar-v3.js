...
const DEFAULT_TRUST_SECONDS={TikTok:720,Facebook:900,YouTube:1200,Instagram:900};
...
function ensureLiveTrustGate(){
  ...
  const script=document.createElement('script');script.src='./live-trust-gate-v1.js?v=1.2';script.dataset.pass50LiveTrustGate='1.2';document.head.appendChild(script);
}
