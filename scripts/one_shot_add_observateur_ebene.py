...
def bump_versions():
 ...
 replace_all(SW,'./v9-tools.js?v=15.10','./v9-tools.js?v=15.13')
 replace_all(SW,'./pass50_nouveaux_candidats_90_v19.json?v=22.11','./pass50_nouveaux_candidats_90_v19.json?v=22.13')
 for path in (ROOT/'tests').glob('test_*.py'):
  text=path.read_text(encoding='utf-8')
  new=text.replace('pass50_nouveaux_candidats_90_v19.json?v=22.11','pass50_nouveaux_candidats_90_v19.json?v=22.13').replace("CENSUS_VERSION='97-v28'","CENSUS_VERSION='99-v30'").replace('v9-tools.js?v=15.10','v9-tools.js?v=15.13').replace('v9-tools.js?v=15.9','v9-tools.js?v=15.13').replace('"15.10"','"15.13"').replace('"15.9"','"15.13"')
