(function(){
  ...
  const ADMIN_ITEMS=[
    ...
    ['quality','Contrôle qualité'],['ranking','Classement'],['data','Maintenance']
  ];
  const ADMIN_DESCRIPTIONS={
    ...
    quality:'Repérer les données manquantes ou incohérentes.',ranking:'Prévisualiser et publier le classement.',
