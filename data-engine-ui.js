(function(){
  ...
  function deDrawMetricsDiagnostic(pane){
    ...
    const ranking=data.ranking||{},volumes=data.volumes||{},fresh=data.freshness||{},collections=data.collections||{},canonical=data.canonicalSchema||{},metricCollectors=data.collectors||{},platforms=data.platforms||[],errors=collections.recentErrors||[],schemaApplied=canonical.migrationStatus==='applied';
    const kpis=[
