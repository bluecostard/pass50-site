(function(){
  ...
  function deDrawMetricsDiagnostic(pane){
    ...
    const ranking=data.ranking||{},volumes=data.volumes||{},fresh=data.freshness||{},collections=data.collections||{},canonical=data.canonicalSchema||{},platforms=data.platforms||[],errors=collections.recentErrors||[];
    const kpis=[
